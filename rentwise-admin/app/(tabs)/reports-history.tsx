...
export default function ReportsHistory() {
  ...
  const tourSteps: HelpStep[] = [
    ...
    { key: "summary", ref: summaryRef, title: "Pending / Approved", description: "How many of your submitted reports are still pending the owner's review, and how many were approved this week.", offsetY: 41 },
    { key: "list", ref: listRef, title: "Report history", description: "Every update report you've submitted to the owner, grouped by date, with its current approval status.", offsetY: 41 },
  ];
