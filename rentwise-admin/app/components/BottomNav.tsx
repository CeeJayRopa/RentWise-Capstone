...
// stays mounted across every tab switch (unlike the old per-page BottomNav),
// so the active-tab pill can genuinely slide from one tab's position to
// another instead of just appearing already-switched.
